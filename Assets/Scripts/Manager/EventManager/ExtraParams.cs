...
public class ExtraParams
{
    ...
    public SpawnInfoContainer SpawnInfo { get => spawnInfo; set => spawnInfo = value; }
    ...
    public ExtraParams(int id, string name, int intvalue, float floatvalue, List<Vector2> vecList, PrefabSet_so mobLists, SpawnInfoContainer spawnInfo, string name2, bool boolvalue, EventPhase_so nextPhase, DialogInfo_so dialog_so, AudioClip audioclip)
    {
        this.id = id;
        this.name = name;
