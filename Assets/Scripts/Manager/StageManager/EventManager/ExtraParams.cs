...
public class ExtraParams
{
    ...
    [SerializeField] private GameObject mobLists = new GameObject();
    ...
    public GameObject MobLists { get => mobLists; set => mobLists = value; }
    ...
    public ExtraParams(int id, string name, int intvalue, float floatvalue, List<Vector2> vecList, GameObject mobLists, string name2, bool boolvalue, EventPhase_so nextPhase, DialogInfo_so dialog_so, AudioClip audioclip)
    {
        this.id = id;
        this.name = name;
