...
public class Spawner : MonoBehaviour
{
    ...
    public void AddOriginal(List<GameObject> original_list)
    {
        original.AddRange(original_list);
    }

    // 특정 위치에 적 오브젝트를 소환하고 내부 clones리스트에 오브젝트를 추가
    public void Spawn_Enemy_AtPosition(int id, Vector2 pos)
    {
    ...
    // 클론 리스트에서 클론을 찾아 제거    
    public void Delete_FromCloneList(GameObject clone)
    {
