...
public class Water_Element : Spell_Element
{
    [SerializeField] private GameObject slow_buff_origin;

    public override void Awake()
    {
        base.Awake();
        level.numberName = "Water";
        level.numberValue = 1;
    ...
    public override void TriggerEnterStackProcess(DelegateParameter para)
    {
        ...
        GameObject clone = target_buffManager.AddBuff(slow_buff_origin);
        Debug.Log(string.Format("{0} is slowed, {1}", para.collision, target_buffManager));
